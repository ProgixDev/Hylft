...
const STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    route: "/(tabs)/home",
    tabRoute: "home",
    targetId: "home.weekConfigureButton",
    labelKey: "home.configureWeek",
    titleKey: "appTutorial.steps.homeWeekConfig.title",
    bodyKey: "appTutorial.steps.homeWeekConfig.body",
    icon: "settings",
    accent: "#06B6D4",
  },
  {
    id: "objective-days",
    route: "/objective?tutorialStep=days",
    targetId: "objective.footerAction",
    labelKey: "appTutorial.steps.objectiveDays.label",
    titleKey: "appTutorial.steps.objectiveDays.title",
    bodyKey: "appTutorial.steps.objectiveDays.body",
    icon: "calendar",
    accent: "#14B8A6",
  },
  {
    id: "objective-routines",
    route: "/objective?tutorialStep=routines",
    targetId: "objective.createRoutineButton",
    labelKey: "appTutorial.steps.objectiveRoutines.label",
    titleKey: "appTutorial.steps.objectiveRoutines.title",
    bodyKey: "appTutorial.steps.objectiveRoutines.body",
    icon: "clipboard",
    accent: "#84CC16",
  },
  {
